...
//start
    if (two === "TAKE PILL") {
        alert("After you take the pill, you imediately become drowsy and everything blurs. You're out before you hit the ground.");
        ...
        //Main loop activated when inRoom = true
        while (inRoom === true) {
            search = function (answer) {
                if (answer == "INSPECT CABINETS" && hasKey === 1 || answer == "1" && hasKey === 1) {
                    alert("You have already checked this. There is nothing in there but the scrap of paper with the numbers '38495' on it.");
                }
                if (answer == "INSPECT CABINETS" && hasKey != 1 || answer == "1" && hasKey != 1) {
                ...
                } else if (answer === "GET ON COMPUTER" || answer == "3") {
                ...
                else if (answer === "OPEN DOOR" && hasKey === 1 || answer === "2" && hasKey === 1) {
            ...
            search(prompt("What do you want to do? (1.Inspect Cabinets 2.Open Door 3.Get On Computer)").toUpperCase());
        }
        ...
        while (inRoom2 === true) {
            roomTwo = function (answer) {
                if (answer === "INSPECT DOOR ONE" || answer == "1") {
                    alert("The door is locked and there is no label.");
                } else if (answer === "INSPECT DOOR TWO" && janitorKey < 1 || answer == "2" && janitorKey < 1) {
                    alert("The door is locked, but you see a label on the wall. This is the Janitors closet.");
                } else if (answer === "INSPECT DOOR TWO" && janitorKey == 1 && ladder === 1 || answer === "2" && janitorKey == 1 && ladder === 1) {
                    alert("You already looked in here.");
                } else if (answer === "INSPECT DOOR TWO" && janitorKey == 1 && ladder === 0 || answer === "2" && janitorKey == 1 && ladder === 0) {
                ...
                } else if (answer === "INSPECT DOUBLE DOORS" || answer == "3") {
                        ...
                        if (answer === "YES") {
                            ...
                            while (inRoom3 === true) {
                                lobbyDirectory = function (answer) {
                                    if (answer === "INSPECT CHAIRS" && string == 1 || answer === "2" && string == 1) {
                                        alert("You already looked over here.");
                                    }
                                    if (answer === "INSPECT CHAIRS" && string == 0 || answer === "2" && string == 0) {
                                    ...
                                    if (answer === "INSPECT RECEPTION DESK" || answer === "3") {
                                        if (janitorKey === 1) {
                                    ...
                                    if (answer === "INSPECT BARRED DOUBLE DOORS" && ventKey == 1 || answer === "5" && ventKey == 1) {
                                    ...
                                    if (answer === "INSPECT BARRED DOUBLE DOORS" && ventKey == 0 || answer === "5" && ventKey == 0) {
                                        alert("The door appears to be locked but you see light coming from the crack underneath the door.");
                                    }
                                    if (answer == "GO BACK TO HALLWAY" || answer == "1") {
                                        visitHallway = 1;
                                        leaveRoom3();
                                    }
                                    if (answer == "TRY TO FIGURE OUT WHERE THE COLD BREEZE IS COMING FROM" && ventKey == 1 || answer == "4" && ventKey == 1) {
                                        alert("You've already looked up there.");
                                    }
                                    if (answer == "TRY TO FIGURE OUT WHERE THE COLD BREEZE IS COMING FROM" && ventKey == 0 || answer == "4" && ventKey == 0) {
                                ...
                                lobbyDirectory(prompt("What do you want to do? (1.Go Back To Hallway 2.Inspect Chairs 3.Inspect Reception Desk 4.Try To Figure Out Where The Cold Breeze Is Coming From 5.Inspect Barred Double Doors)").toUpperCase());
                            }
                        }
                    };
            ...
            roomTwo(prompt("What do you want to do? (1.Inspect Door One 2.Inspect Door Two 3.Inspect Double Doors)").toUpperCase());

        }
    } else if (two !== "TAKE PILL") {
        alert("You don't take the pill. You lose.");
    }
}